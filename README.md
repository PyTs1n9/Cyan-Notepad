...
<img src="./src-tauri/icons/Square142x142Logo.png" width="155" alt="Cyan Notepad 图标">
...
当前版本为 **v0.4** 最终版。本地数据默认保存在应用数据目录；启用在线工作台后，账户、工作台元数据和云文档会通过你配置的 Supabase 与协作服务同步。
